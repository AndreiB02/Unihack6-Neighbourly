                    ...
                    <View style={styles.modalBackground}>
                        <TouchableWithoutFeedback>
                            <View style={styles.modalContainer}>
                                ...
                                <TouchableOpacity style={[styles.modalButton, { backgroundColor: '#FF5722' }]} onPress={() => setDeleteModalVisible(false)}>
            ...
            <Modal visible={pauseModalVisible} transparent={true} animationType="fade">
                <TouchableWithoutFeedback onPress={() => setPauseModalVisible(false)}>
                    <View style={styles.modalBackground}>
                        <TouchableWithoutFeedback>
                            <View style={styles.modalContainer}>
                                <Text style={styles.modalTitle}>{isPaused ? "Resume this offer?" : "Pause this offer?"}</Text>
...
export default MYOfferingCardComponent;
